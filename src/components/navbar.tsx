            ...
            <header>
                <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                    ...
                    <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-white justify-center">
                        <a className="mr-5 hover:text-cyan-500 cursor-pointer">HOME</a>
                    ...
                    <button className="inline-flex items-center bg-gradient-to-r from-[#48fc8b] to-[#1de7ea] border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0 cursor-pointer">LOG IN

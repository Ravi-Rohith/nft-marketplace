            ...
            <header>
                <div className="container mx-auto mt-4 flex flex-wrap p-5 flex-col md:flex-row items-center">
                    <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                        <span className="ml-5 text-4xl text-white cursor-pointer">DA</span>
                    </a>
                    ...
                    <button className="inline-flex items-center text-black bg-gradient-to-r from-[#48fc8b] to-[#1de7ea] border-2 border-cyan-500 py-1 px-3 focus:outline-none hover:from-[transparent] hover:to-[transparent] hover:text-white rounded text-base mr-7 mt-4 md:mt-0 cursor-pointer">LOG IN
